...
void mergeTwoFiles(std::string file1, std::string file2, std::string outFile) {
    ...
    bool has1 = (bool)fin1.read((char*)&e1, sizeof(Edge));
    bool has2 = (bool)fin2.read((char*)&e2, sizeof(Edge));

    while (has1 && has2) {
        if (e1.weight >= e2.weight) {
            fout.write((char*)&e1, sizeof(Edge));
            has1 = (bool)fin1.read((char*)&e1, sizeof(Edge));
        } else {
            fout.write((char*)&e2, sizeof(Edge));
            has2 = (bool)fin2.read((char*)&e2, sizeof(Edge));
        }
    }
